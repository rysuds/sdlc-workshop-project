...
// --- Feed Posts ---
export const posts = [
  // 1. Brian McCarthy - new hire intro
  ...
  // 2. Bad Bunny - Super Bowl halftime
  ...
  // 6. Sam Altman - 2-3 weeks (with Dario scared of Cursor)
  ...
  // 9. Zuckerberg - chain at Super Bowl
  ...
  // 11. Dario Amodei - scared of Cursor
  ...
  // 13. Oprah - AI grocery list (with Sam's Cursor job listing joke)
  ...
  // 14. Nicole Zhang - awareness hot take
  ...
  // 18. Taylor Swift - re-recording LinkedIn
  ...
  // 20. Shaq - chicken wing framework
  ...
  // 21. Mahomes - Super Bowl post-game
  ...
  // 24. Trevor Cotta - systems vs vibes
...
export const messages = [
  {
    ...
    preview: 'Hey Sarah, loved your talk at React Conf! Would love to...',
    timeAgo: '10 min ago',
    unread: true,
  },
  {
    ...
    preview: 'Quick question about the API redesign - are we still...',
    timeAgo: '1h ago',
    unread: true,
  },
  {
    id: 'msg-3',
    senderId: null,
    senderName: 'Recruiting @ Stripe',
    preview: 'Hi Sarah, I came across your profile and was impressed by...',
    timeAgo: '3h ago',
    unread: false,
  },
  {
    id: 'msg-4',
    senderId: null,
    senderName: 'Dev Team Chat',
    preview: 'Mike: pushed the fix, can someone review?',
    timeAgo: '5h ago',
    unread: true,
    unreadCount: 4,
  },
  {
    ...
    preview: 'Thanks for the referral! I got the interview 🎉',
    timeAgo: '1d ago',
    unread: false,
  },
];
...
export const suggestedConnections = [
  {
    id: 'user-brian',
    name: 'Brian McCarthy',
    headline: 'New Hire | Father of 5 | Follically Challenged',
